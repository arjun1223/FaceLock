...
The script creates a versioned archive such as `dist/FaceLock-1.0.3-macOS-arm64.zip` plus a SHA-256 checksum. Unzip it, move `FaceLock.app` to `/Applications`, launch it, and grant Camera and Accessibility permissions to that installed copy.
